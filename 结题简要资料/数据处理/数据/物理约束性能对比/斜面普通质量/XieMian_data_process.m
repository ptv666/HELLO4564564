...
% fidin=fopen('E:\_本科毕业设计\结题\数据处理\数据\物理约束性能对比\平地\state_information_沟濠.txt');
% fidin=fopen('E:\_本科毕业设计\结题\数据处理\数据\物理约束性能对比\平地\state_information_随机大块.txt');
fidin=fopen('E:\_本科毕业设计\结题\数据处理\数据\物理约束性能对比\平地\state_information_中间空.txt');
