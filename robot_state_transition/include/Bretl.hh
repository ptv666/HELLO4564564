 ...
 * @Date: 2023-03-16 21:14:31
 * @LastEditors: ptw 1515901920@qq.com
 * @LastEditTime: 2023-03-18 11:14:12
 * @FilePath: /robot_state_transition/include/Bretl.hh
 * @Description: Bretl.hh头文件，目前还存在问题，因为是普通指针，需要改成共享指针或者动态指针然后手动delete
 */
#include "util.hh"
...
namespace Robot_State_Transition
{
     ...
     * @return {*}
     */
    MatrixXX comput_friction_region(const MatrixX3 &contactPoints, const MatrixX3 &contactNormals, const double frictionCoefficient, double m);
}
